...
git -c core.filemode=false add reports/ results/ figures/ mnt/ index.html breast-mri-artifacts.html demo.html mg-risk-demo.html mg-demo.html tumor-seg-demo.html demo-client.js site-theme.css _headers review-system-auth.js
